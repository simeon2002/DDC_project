...
HD_PWD='/home/sims0702/Documents/lab3/lab3.runs/design_1_Debounce_Switch_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Debounce_Switch_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Debounce_Switch_0_1.tcl
